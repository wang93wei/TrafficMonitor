...
CString CommonDisplayItem::GetItemName() const
{
    ...
    else
    {
        ...
        case TDI_GPU_MEMORY: return CCommon::LoadText(IDS_GPU_MEMORY_USAGE);
        default:
            ASSERT(false);
            break;
        }
...
std::wstring CommonDisplayItem::DefaultString(bool is_main_window) const
{
    ...
    else
    {
        ...
        case TDI_HDD_USAGE:
            ...
            break;
        case TDI_GPU_MEMORY:
            default_text = CCommon::LoadText(IDS_GPU_MEMORY_DISP, _T(": "));
            break;
        default:
            ASSERT(false);
            break;
...
const wchar_t* CommonDisplayItem::GetItemIniKeyName() const
{
    ...
    else
    {
        ...
        case TDI_GPU_MEMORY: return L"gpu_memory_string";
        }
        ASSERT(FALSE);
        return L"";
    }
